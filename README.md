...
Autor: Andrius Gimenez Labadessa
...
A aplicação tem como finalidade gerenciar uma lista de tarefas (to-do list), permitindo visualizar, adicionar, editar e remover tarefas.
...
Abra outro terminal e entre na pasta frontend: cd frontend Instale as dependências do projeto: npm install
